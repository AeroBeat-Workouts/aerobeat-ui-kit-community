...
func test_hidden_testbed_manifest_stays_ui_kit_focused() -> void:
	...
	assert_string_contains(manifest_text, '"checkout": "dedcc8bae0fe34dec6ed1bb79ca77bb71746f7df"', "Hybrid touch proof should pin the packaged touch-provider owner-state summary seam commit")
