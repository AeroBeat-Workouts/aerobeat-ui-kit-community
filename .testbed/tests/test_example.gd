...
func test_hidden_testbed_manifest_stays_ui_kit_focused() -> void:
	...
	assert_string_contains(manifest_text, '"checkout": "5dca2a717c55028136067b128981a37605e602fc"', "Hybrid touch proof should pin the packaged touch-provider interaction-summary seam commit")
