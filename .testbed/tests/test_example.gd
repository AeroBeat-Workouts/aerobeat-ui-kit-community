...
func test_hidden_testbed_manifest_stays_ui_kit_focused() -> void:
	...
	assert_string_contains(manifest_text, '"checkout": "9fc9cf0fcf87a4a5c9a60ae29db8ff5bd6b46f92"', "Hybrid touch proof should pin the first extracted aerobeat-spatial-ui-touch runtime slice")
